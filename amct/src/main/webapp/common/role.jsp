            ...
            <div class="layui-row">
                ...
                <div class="layui-col-md10">
                    <div class="layui-form">
                        <div class="layui-inline">
                            <div class="layui-input-inline">
                                <input type="text" value="" placeholder="角色名称" class="layui-input search_input" />
                            </div>
                            <div class="layui-btn-group">
                                <a class="layui-btn layui-btn-primary search_btn"> <i class="layui-icon">&#xe615;</i>查询
                    ...
                    <div class="layui-form role_list">
                        <table class="layui-hide" id="roledatagrid" lay-data="{id: 'roledatagrid'}"
                            lay-filter="roleTableFilter"></table>
                    </div>
                </div>
            </div>
        </div>
