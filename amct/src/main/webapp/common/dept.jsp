			...
			<div class="layui-row">
				...
				<div class="layui-col-md10">
					<div class="layui-form">
						<div class="layui-inline">
							<div class="layui-btn-group">
								<a class="layui-btn layui-btn-primary dept_add"> <i
					...
					<div class="layui-form dept_list">
						<table class="layui-hide" id="deptdatagrid"
							lay-data="{id: 'deptdatagrid'}" lay-filter="deptTableFilter"></table>
					</div>
				</div>
			</div>
		</div>
	...
	<form class="layui-form" action="" lay-filter="dept_form">
		...
		<div class="layui-form-item">
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input type="text" id="tree" name="dept_pid" lay-filter="tree"
						class="layui-input">
				</div>
			</div>
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input type="text" name="dept_code" autocomplete="off"
						class="layui-input">
				</div>
			</div>
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input type="number" name="dept_order" autocomplete="off" value=1
						class="layui-input">
				</div>
			</div>
			<label class="layui-form-label">备注</label>
			<div class="layui-input-block">
				<textarea id="dept_remark" name="dept_remark" placeholder="备注"
		...
		<div class="layui-form-item">
			<div class="layui-input-block" style="margin-left: 78%">
				<button type="submit" class="layui-btn" lay-submit=""
					lay-filter="deptSubmit">立即提交</button>
			</div>
		</div>
	</form>
</div>
